...
router.get('/results', isDegustationLock, isDegustatorAuth, degustatorControler.getResults);

router.get('/result/:resultId', isDegustationLock, isDegustatorAuth, degustatorControler.getResult);
